...
function swm_google_fonts_list() {

  $swm_google_font_families = array(
'ABeeZee'                  => 'ABeeZee',
'Abel'                     => 'Abel',
...
'Zilla Slab Highlight'     => 'Zilla Slab Highlight'
  ...
  return $swm_google_font_families;

}


function swm_google_fonts_weight() {
  ...
  return $swm_google_fonts_weight;

}


function swm_fonts_all_weights() {

  $swm_google_fonts_all_weights = array(
    '100'       => esc_html__( 'Ultra Light', 'bizix' ),
    '100italic' => esc_html__( 'Ultra Light Italic', 'bizix' ),
    '200'       => esc_html__( 'Light', 'bizix' ),
    '200italic' => esc_html__( 'Light Italic', 'bizix' ),
    '300'       => esc_html__( 'Book', 'bizix' ),
    '300italic' => esc_html__( 'Book Italic', 'bizix' ),
    '400'       => esc_html__( 'Regular', 'bizix' ),
    '400italic' => esc_html__( 'Regular Italic', 'bizix' ),
    '500'       => esc_html__( 'Medium', 'bizix' ),
    '500italic' => esc_html__( 'Medium Italic', 'bizix' ),
    '600'       => esc_html__( 'Semi-Bold', 'bizix' ),
    '600italic' => esc_html__( 'Semi-Bold Italic', 'bizix' ),
    '700'       => esc_html__( 'Bold', 'bizix' ),
    '700italic' => esc_html__( 'Bold Italic', 'bizix' ),
    '800'       => esc_html__( 'Extra Bold', 'bizix' ),
    '800italic' => esc_html__( 'Extra Bold Italic', 'bizix' ),
    '900'       => esc_html__( 'Ultra Bold', 'bizix' ),
    '900italic' => esc_html__( 'Ultra Bold Italic', 'bizix' )
  );

  return $swm_google_fonts_all_weights;

}

function swm_check_google_font_italic( $font_weight_and_style ) {
...
function swm_google_fonts_final_weight( $font_weight_and_style ) {

  $swm_google_fonts_final_weight = ( swm_check_google_font_italic( $font_weight_and_style ) ) ? str_replace( 'italic', '', $font_weight_and_style ) : $font_weight_and_style;

  return $swm_google_fonts_final_weight;

}

function swm_google_fonts_query( $font_family ) {

  $swm_font_family_query = str_replace( ' ', '+', $font_family );

  return $swm_font_family_query;
