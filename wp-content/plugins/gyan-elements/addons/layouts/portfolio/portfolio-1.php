    ...
    if ( 'yes' === $data['show_overlay'] ) :  ?>
        ...
        <div class="gyan-portfolio-overlay gyan-overlay gyan-flex">
            <div class="gyan-portfolio-all-content gyan-ease-transition gyan-flex">
                ...
                <?php if ( 'yes' === $data['show_zoom_icon'] || 'yes' === $data['show_link_icon'] || 'yes' === $data['show_title'] || 'yes' === $data['show_category'] || 'yes' === $data['show_excerpt']  ) :
                    ?>
                    ...
                    ?>">
                        ...
                        <?php if ( 'yes' === $data['show_zoom_icon'] || 'yes' === $data['show_link_icon'] ) : ?>
                            ...
                            <div class="gyan-portfolio-hover-icons">
                                ...
                                <?php if ( 'yes' === $data['show_zoom_icon'] && '' != $click_action ) {  ?>
                                    <a <?php echo $this->get_render_attribute_string( 'grid-media-' . $index ); ?> ><span class="gyan-icon"><?php echo $zoom_icon;?></span></a>
                                 <?php } ?>

                                <?php if ( 'yes' === $data['show_link_icon'] ) {  ?>
                                   <a href="<?php echo esc_url( $get_permalink ); ?>" class="gyan-portfolio-link-icon gyan-flex gyan-ease-transition"><span class="gyan-icon"><?php echo $link_icon;?></span></a>
                                <?php } ?>
